<template>
  <div class="airshow reservations">

    <div class="fix-wrap">
      <div class="title-wrap">
        <div class="icon" @click="back">
        </div>
        <div class="txt">中国航展公众号</div>
      </div>
    </div>
    <div class="wrap">

      <div class="section">
        <h3 style="margin-top: .5rem">请关注“中国航展”公众号</h3>
        <div class="img-wrap" style="text-align: center;width: 100%;margin: .5rem 0">
          <img src="../../assets/images/WechatIMG251.png" alt="" width="300">
        </div>
      </div>
    </div>
