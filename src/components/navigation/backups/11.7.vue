      ...
      <div class="current" v-show="currentIndex===0">
        ...
        <div class="main">
          ...
          <div class="map-container" id="container-map">
            ...
            <div class="list" v-show="position&&getbus().length">
            ...
            <div class="list" v-show="infoflag&&!getbus().length">
              <div class="title clearfix">
                <div class="left">起</div>
                <div class="right">我的位置</div>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      selcet(item) {
        ...
        console.log(_this.getbus().length);
        // setTimeout(()=>{
        //   if (!_this.selectflag) {
        //     _this.map.clearMap();
        //     console.log(item);
